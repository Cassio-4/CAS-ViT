...
def get_args_parser():
    ...
    parser.add_argument('--pretrained', action="store_true", help='If model should load weights from --weights_path')
    ...
    # Data
    parser.add_argument('--data_path', default='/home/cassio/Documents/Doutorado/Disciplinas/RNA/cats_resized', type=str,
                        help='dataset path')
...
def get_model(args):
    ...
    if args.adapter is True:
        ...
        if args.pretrained and args.weights_path is not None:
...
if __name__ == '__main__':
    ...
    # Start finetune, return test set and tuned model
    model, dl_test = train(args, model, device)
